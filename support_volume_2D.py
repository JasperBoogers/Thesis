...
if __name__ == "__main__":
    ...
    plt.legend()
    plt.savefig('out/supportvolume/2D_solution_comp_fixed.svg', format='svg', bbox_inches='tight')
    plt.show()
    ...
    start = time.time()
    res_euler = minimize(support_2D_Euler, t0, args=(p, f, n, plane), method='BFGS',
